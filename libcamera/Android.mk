...
LOCAL_C_INCLUDES := hardware/ti/omap3/dspbridge/inc \
    $(HARDWARE_TI_OMAP3_BASE)/omx/system/src/openmax_il/lcml/inc \
    $(HARDWARE_TI_OMAP3_BASE)/omx/system/src/openmax_il/omx_core/inc \
    $(HARDWARE_TI_OMAP3_BASE)/omx/system/src/openmax_il/common/inc \
    $(HARDWARE_TI_OMAP3_BASE)/omx/image/src/openmax_il/jpeg_enc/inc \
    $(HARDWARE_TI_OMAP3_BASE)/libexif \
    $(LOCAL_PATH)/inc \
    $(HARDWARE_TI_OMAP3_BASE)/hwc \
    $(LOCAL_PATH)/inc/V4LCameraAdapter \
    $(HARDWARE_TI_OMAP3_BASE)/libtiutils \
